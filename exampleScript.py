...
print("Hydrate Densities (kg/m^3): " + str([round(num, 2) for num in hydrateDensities]))
print("Guest Storage Capacities (kg/m^3): " + str([round(num, 2) for num in storageDensity]))
